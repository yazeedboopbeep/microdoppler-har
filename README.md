...
`data/spectrograms.npz` (3.8 MB) is the preprocessed cache the scripts use.
It is committed so everything below runs without downloading the 2 GB
archive. The raw `.dat` files are not in the repo.
